    ...
    <main className="login-page">
      <form onSubmit={handleSubmit} className="login-page__form">
        ...
        <div className="login-page__form__input">
          <Input placeholder="Ex.: name@domain.com" label="Email" type="email" value={email} onChange={({ target: { value } }) => setEmail(value)} />
        </div>

        <div className="login-page__form__input">
          <Input placeholder="A nice name" label="Name" type="text" value={name} onChange={({ target: { value } }) => setName(value)} />
        </div>

        <div className="login-page__form__input">
          <Input placeholder="A safe password" label="Name" type="password" value={password} onChange={({ target: { value } }) => setPassword(value)} />
        </div>
